...
\begin{itemize}
	...
	\item
		...
		\vspace{3 mm}
		\begin{itemize}
			\item Led the frontend architecture for Superhuman Go, an agent-based AI assistant, powering a consistent experience across native and web platforms; built on by 30+ engineers across 5+ teams.
			\item Developed the core frontend platform for Superhuman Go, providing the building blocks for agentic chat, multi-agent support, and editable tool calls.
