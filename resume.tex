...
\begin{itemize}
	...
	\item
		...
		\begin{itemize}
			...
			\item Other noteable projects -- End-to-end testing framework for Coursera’s codebase using Puppeteer and Jest; improving web performance for the in-course learning experience using server-side rendering; key product features including content authoring tools, rating systems and framework to display realtime helpful tips to learners.
		\end{itemize}
