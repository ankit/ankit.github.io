...
\begin{itemize}
	...
	\item
		...
		\vspace{3 mm}
		\begin{itemize}
			\item Leading the technical strategy and frontend architecture for Grammarly’s agent-based assistant UI. Coordinating 10+ engineers across 3 teams to ensure alignment. Driving a consistent implementation across web and native platforms.
