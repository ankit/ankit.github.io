...
\begin{itemize}
	...
	\item
		...
		\vspace{3 mm}
		\begin{itemize}
			\item Led frontend technical strategy and architecture for Grammarly's agent-based assistant, aligning 10+ engineers across 3 teams. Defined and drove a shared vision across web and native platforms to ensure architectural consistency and long-term scalability.
