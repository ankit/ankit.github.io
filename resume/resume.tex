...
\begin{itemize}
	...
	\item
		\begin{tabular*}{6in}{l@{\extracolsep{\fill}}r}
			\textbf{Superhuman, New York} (formerly Grammarly) & August 2022 - Present\\
		\end{tabular*}
		Staff Software Engineer \\
		\vspace{3 mm}
		\begin{itemize}
			\item Led the frontend architecture for Superhuman Go, an agent-based assistant; coordinated 15+ engineers across 3+ teams to deliver a unified, scalable experience across web and native platforms.
			\item Developed the core frontend platform for Superhuman Go, providing the building blocks for LLM chat, multi-agent support, and editable tool calls.
