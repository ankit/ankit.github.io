...
\begin{itemize}
	...
	\item
		...
		\vspace{3 mm}
		\begin{itemize}
			\item Led frontend architecture and development for Superhuman Go, an agent-based assistant; coordinated 15+ engineers across 3+ teams to deliver a unified, scalable experience across web and native platforms.
